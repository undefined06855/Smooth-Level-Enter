...
- Update mod icon to fix the border
- Added more info to the mod description (ThePerpelGod)

## v1.0.2
- Fixed a crash when completing a quest (and improve mod compatibility in general)
